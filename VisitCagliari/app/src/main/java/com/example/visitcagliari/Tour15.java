...
public class Tour15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour15_activity);

        // Trova le card
        card1 = findViewById(R.id.tour15_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour15.this, Pianifica.class);
