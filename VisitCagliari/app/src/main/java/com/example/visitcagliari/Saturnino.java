...
public class Saturnino extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.saturnino);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng map = new LatLng(39.21409062342367, 9.123166636953723);
