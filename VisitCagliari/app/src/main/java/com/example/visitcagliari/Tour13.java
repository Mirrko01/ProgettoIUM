...
public class Tour13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour13_activity);

        // Trova le card
        card1 = findViewById(R.id.tour13_1);
        card2 = findViewById(R.id.tour13_2);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour13.this, Pianifica.class);
