...
public class Tour23 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour23_activity);

        // Trova le card
        card1 = findViewById(R.id.tour23_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour23.this, Pianifica.class);
