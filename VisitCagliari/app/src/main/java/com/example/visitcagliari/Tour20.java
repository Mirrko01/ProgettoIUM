...
public class Tour20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour20_activity);

        // Trova le card
        card1 = findViewById(R.id.tour20_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour20.this, Pianifica.class);
