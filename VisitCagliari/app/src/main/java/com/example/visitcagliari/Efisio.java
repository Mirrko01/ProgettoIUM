...
public class Efisio extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.efisio);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng map = new LatLng(39.219552602913005, 9.11289159647702);
