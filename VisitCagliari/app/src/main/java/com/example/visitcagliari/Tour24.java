...
public class Tour24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour24_activity);

        // Trova le card
        card1 = findViewById(R.id.tour24_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour24.this, Pianifica.class);
