...
public class Tour22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour22_activity);

        // Trova le card
        card1 = findViewById(R.id.tour22_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour22.this, Pianifica.class);
