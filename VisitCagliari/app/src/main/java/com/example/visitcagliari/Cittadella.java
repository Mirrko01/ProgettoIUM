...
public class Cittadella extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cittadella);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng map = new LatLng(39.22236640382558, 9.116827082984745);
