...
public class Tour14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour14_activity);

        // Trova le card
        card1 = findViewById(R.id.tour14_1);
        card2 = findViewById(R.id.tour14_2);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour14.this, Pianifica.class);
