...
public class Tour6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour6_activity);

        // Trova le card
        card1 = findViewById(R.id.tour6_1);
        card2 = findViewById(R.id.tour6_2);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour6.this, Pianifica.class);
