...
public class Tour16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour16_activity);

        // Trova le card
        card1 = findViewById(R.id.tour16_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour16.this, Pianifica.class);
