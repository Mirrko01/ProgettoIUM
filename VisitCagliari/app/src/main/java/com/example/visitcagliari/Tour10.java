...
public class Tour10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour10_activity);

        // Trova le card
        card1 = findViewById(R.id.tour10_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour10.this, Pianifica.class);
