...
public class Tour11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tour11_activity);

        // Trova le card
        card1 = findViewById(R.id.tour11_1);
        ...
        undo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Tour11.this, Pianifica.class);
